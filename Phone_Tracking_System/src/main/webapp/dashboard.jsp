                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="searchQuery" 
                                           name="searchQuery" placeholder="Enter phone number or email" required>
                                </div>
                                <div class="col-md-3">
                                        ...
                                        <tbody>
                                            <c:forEach items="${trackingHistory}" var="track" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <fmt:formatDate value="${track.trackedAt}" pattern="dd/MM/yyyy HH:mm"/>
                                                    </td>
                                                    <td>
